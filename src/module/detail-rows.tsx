                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        {ProductData.map((product, productIndex) => (
                            <>
                                <tr className={`border-b hover:bg-gray-50 ${productIndex % 2 === 0 ? "bg-white" : "bg-gray-100"}`}>
                                ...
                                <tr className={`bg-white border-b hover:bg-gray-50 ${expandableIndexes.includes(product.ProductID) ? "" : "hidden"}`}>
                                    <td></td>
                                    <td colSpan={4}>
